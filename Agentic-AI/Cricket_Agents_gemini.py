...
match_agent = Agent(
    ...
    tools=[DuckDuckGo()],
    instructions=[
        "Search for live cricket match scores ind vs south africa.",
...
cricket_team.print_response(
    "Create summarize table to Get the latest score of the India vs Australia match, recent performance for abhisekh sharma, and cricket news.",
    stream=True
)