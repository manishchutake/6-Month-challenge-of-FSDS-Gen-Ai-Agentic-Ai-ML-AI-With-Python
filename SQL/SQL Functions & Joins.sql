...
mysql> create table emp(id int null primary key, salary int,, empcode int, name varchar(30);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near ', empcode int, name varchar(30)' at line 1
mysql> create table emp(id int not null primar key, salary int,, empcode int, name varchar(30));
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'primar key, salary int,, empcode int, name varchar(30))' at line 1
mysql> create table emp(id int not null primar key, salary int,, empcode int, name varchar(30));
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'primar key, salary int,, empcode int, name varchar(30))' at line 1
mysql> create table emp(id int not null primar key, salary int,, empcode int, name varchar(30));
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'primar key, salary int,, empcode int, name varchar(30))' at line 1
...
mysql> insert into emp values(12,20000,102,'aman'),(23, 60000,104, 'arup'),(78, 30000,105, 'max'),(80, 25000, 103,'ram'),(34, 90000, 106, 'sam')
    ...
    -> ;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'insert into emp values(12,20000,102,'aman'),(23, 60000,104, 'arup'),(78, 30000,1' at line 2
mysql> insert into emp values(12,20000,102,'aman'),(23, 60000,104, 'arup'),(78, 30000,105, 'max'),(80, 25000, 103,'ram'),(34, 90000, 106, 'sam');
...
+---------+----+---------+-------+----+--------+---------+------+
25 rows in set (0.010 sec)

mysql> select * fromemp cross join student;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'fromemp cross join student' at line 1
